...
const Sidebar = () => {
    ...
    const filterUsers = input ? users.filter((user)=>user.fullName.toLowerCase().
    ...
    text-white ${selectedUser ? "max-md:hidden" : ''}`}>
        <div className='pb-5'>
            ...
            mt-5'>
                ...
                <input onChange={(e)=>setInput(e.target.value)} type="text" className='bg-transparent borsder-none outline-none
